...
const LOOT_TABLES: Dictionary = {
	...
	"giftbox_gold": [
		...
		[10, {"type": "item", "id": "gem_purple", "qty": 1}],
		[30, {"type": "blessing_choice"}],
		[20, {"type": "random_buff"}],
		[10, {"type": "item", "id": "silver", "qty": 8}],
		[5, {"type": "nothing"}],
	],
	"giftbox_mystic": [
		[15, {"type": "item", "id": "gem_purple", "qty": 1}],
		[10, {"type": "item", "id": "gem_blue", "qty": 3}],
		[30, {"type": "blessing_choice"}],
		[25, {"type": "blessing_scroll"}],
		[15, {"type": "random_buff"}],
		[5, {"type": "nothing"}],
	],
	"giftbox_cursed": [
		...
		[20, {"type": "blessing_choice"}],
		[30, {"type": "curse_debuff"}],
		[15, {"type": "item", "id": "gold", "qty": 1}],
		[13, {"type": "item", "id": "silver", "qty": 10}],
		[5, {"type": "nothing"}],
	],
	"giftbox_celestial": [
		[10, {"type": "item", "id": "gem_red", "qty": 1}],
		[10, {"type": "item", "id": "gem_purple", "qty": 3}],
		[30, {"type": "blessing_choice"}],
		[25, {"type": "blessing_scroll"}],
		[15, {"type": "item", "id": "gold", "qty": 2}],
		[5, {"type": "item", "id": "gem_red", "qty": 2}],
		[5, {"type": "nothing"}],
	],
}
